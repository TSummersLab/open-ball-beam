...
//const int SERVO_CMD_MIN = 1000;  // in microseconds
//const int SERVO_CMD_MAX = 2000;  // in microseconds
const int SERVO_CMD_MID = 1540;  // in microseconds
const int SERVO_CMD_MIN = 1540-333;  // in microseconds
const int SERVO_CMD_MAX = 1540+333;  // in microseconds
